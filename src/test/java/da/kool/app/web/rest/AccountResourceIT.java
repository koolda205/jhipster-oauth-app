...
import static da.kool.app.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static da.kool.app.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static da.kool.app.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import da.kool.app.IntegrationTest;
import da.kool.app.repository.UserRepository;
import da.kool.app.security.AuthoritiesConstants;
