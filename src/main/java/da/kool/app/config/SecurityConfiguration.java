...
import da.kool.app.security.*;
import da.kool.app.security.SecurityUtils;
import da.kool.app.security.oauth2.AudienceValidator;
import da.kool.app.security.oauth2.CustomClaimConverter;
import da.kool.app.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .oauth2Login(oauth2 -> oauth2.loginPage("/").userInfoEndpoint(userInfo -> userInfo.userService(this.oauth2UserService())))
            .oauth2Client(withDefaults());
